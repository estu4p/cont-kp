...
Route::get('/editUsermitra',[AdminUnivAfterPaymentController::class, 'editUsermitra'])->name('editmitra');
Route::post('/editUsermitra/update',[AdminUnivAfterPaymentController::class, 'editUsermitraupdate'])->name('editmitra');
