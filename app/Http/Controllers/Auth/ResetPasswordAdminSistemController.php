...
use App\Models\User;
use App\Mail\SendEmailAdminSistem;
...
class ResetPasswordAdminSistemController extends Controller
{
    public function resetPassword(Request $request){
        ...
        try {
            Mail::to($request->email)->send(new SendEmailAdminSistem($otp));
            return redirect()->to('/user-AdminSistem/InputOTP');
        } catch (\Exception $e) {
    ...
    public function verifyOTP(Request $request)
    {
        ...
        return redirect()->to('/user-AdminSistem/InputnewPassword');
    }
    public function newPassword(Request $request)
    {
        ...
        return redirect()->to('/user-AdminSistem/login');
    }
