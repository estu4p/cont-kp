...
<body>
    <a href="/superAdmin/login"><button class="kembali"><i class="fa-solid fa-angle-left"></i>Kembali ke halaman
            utama</button></a>
    <div class="wadah justify-content-center">
        ...
        <form action="{{ route('password.resetSuperAdmin') }}" method="POST">
            @csrf
            ...
            @endif
            <div class="bawah">
                <button style="text-decoration: none;" id="kirim-otp" type="submit" class="continue">Continue</button>
            </div>
        </form>
    </div>
