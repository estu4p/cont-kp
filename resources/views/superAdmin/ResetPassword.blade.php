...
<body>
    <a href="/superAdmin/login"><button class="kembali"><i class="fa-solid fa-angle-left"></i>Kembali ke halaman utama</button></a>
    <div class="wadah justify-content-center">
        ...
        <form action="" method="POST">
            ...
            <div class="bawah">
                <a href="/superAdmin/login/OTP" style="text-decoration: none;" id="kirim-otp" type="submit"><button class="continue">Continue</button></a>
            </div>
        </form>
    </div>
