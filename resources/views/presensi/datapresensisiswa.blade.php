            ...
            <div class="col-md-12 parent-relative">
                ...
                <div class="card">
                    <div class="card-header" style="display: grid; grid-template-columns: auto 1fr auto;">
                        ...
                        <div>
                            <h3 style="font-size: 50px; margin: 0;">{{ $datasiswa->user->nama_lengkap }}</h3>
                            <p style="margin: 0;">NIP : {{ $datasiswa->user->nomor_induk }}</p>
                        </div>
                    ...
                    <div class="masa">
                        <table>
                            <tbody>
                                <tr >
                                    <th>Masa</th>
                                    <td>{{ $datasiswa->user->tgl_masuk }}</td>
                                    <td>{{ $datasiswa->user->tgl_keluar }}</td>
                                </tr>
                                <tr>
                                    <th>Jam Default Masuk</th>
                                    <td>{{ $datasiswa->user->jam_default_masuk }}</td>
                                </tr>
                                <tr>
                                    <th>Jam Default Pulang</th>
                                    <td>{{  $datasiswa->user->jam_default_pulang }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                        ...
                        <table>
                            <tbody>
                                <tr>
                                    ...
                                    <td><span class="masuk">{{ $datasiswa->total_jam_masuk }}</span></td>
                                </tr>
                                <tr>
                                    <th>total masuk</th>
                                ...
                                <tr>
                                    <th>target</th>
                                    <td><span class="target">{{ $datasiswa->target }}</span></td>
                                </tr>
                                <tr>
                                    <th>sisa</th>
                                    <td><span class="sisa">{{ $datasiswa->sisa_jam }}</span></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
