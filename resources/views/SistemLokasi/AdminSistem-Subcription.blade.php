                        ...
                        <div class="modal-body modalbodi">
                            ...
                            <div class="kiri">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="nama" value="{{ $subscription->user_id}}">
                                    <input type="text" class="inputt" id="nama" value="{{ $subscription->nama_lengkap}}">
                                </div>
                                <div class="form-group">
                                    <label for="Email">Email</label>
                                    <input type="text" class="inputt" id="Email" name="email" value="{{ $subscription->email}}" placeholder="email">
                                </div>
                                <div class="form-group">
                                    <label for="Telepon">Telepon</label>
                                    <input type="number" class="inputt" id="Telepon" name="no_hp" value="{{$subscription->no_hp}}">
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="form-select" aria-label="Default select example" name="sekolah">
                                        <option selected>{{$subscription->sekolah}}</option>
