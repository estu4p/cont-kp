        ...
        <div class="kiri col-4 overflow-hidden">
            <div>
                <ul class="nav nav-tabs">
                    <li class="nav-item"><a style="font-size: 80%;" class="nav-link bg-secondary-subtle text-dark" href="/UserScanBarcode"><b>Scan Presensi Harian</b></a></li>
                    <li class="nav-item active"><a style="font-size: 80%;" class="nav-link active" href="/UserPresensi"><b>Scan Ganti Jam</b></a></li>
                </ul>
            </div>
            <div class=" border border-top-0 ">
                <br>
                <p style="text-align: center;">Scan Barcode Anda</p>
                <img src="assets/images/barcode1.png" alt="Barcode">
                <p style="text-align: center;" class="p1"><i class="ikon bi bi-exclamation-triangle-fill"></i> arahkan Barcode pada kamera</p>
            </div>
        </div>
