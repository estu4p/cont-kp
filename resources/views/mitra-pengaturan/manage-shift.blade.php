...
@section('content')
    ...
    <div class="kiri-putih p-5 ">
        ...
        <a class="" href="{{ route('mitra.pengaturan.divisi') }}">
    ...
    <div class="container-fluid  d-flex flex-row justify-content-start gap-0 p-0 wadah">
        ...
        <div class="kanan-tabel p-5  w-100 justify-content-start ">
            ...
            <div class="btn-jam px-0 d-flex align-items-center  justify-content-between row my-2 mx-0">
                <label class="form-check-label col-6 " style="white-space: nowrap;" for="flexSwitchCheckDefault">Ganti
                    Jam</label>
                <div
                    class="form-check justify-content-center d-flex text-center align-items-center col-6 form-switch swic ">
                    ...
                    <tbody>
                        ...
                        @foreach ($shift as $shifts)
                            ...
                            <tr>
                                ...
                                <td class="ratatengah">
                                    <form action="{{ route('mitra.deleteshift', ['id' => $shifts->id]) }}" method="POST"
                                        class="delete-form">
                                        @csrf
                                        @method('DELETE')
                                        <button class="btn btn-edit btn-sm" data-idUpdate="'.$shift->id'"
                                            data-bs-target="#editModal{{ $shifts->id }}" data-bs-toggle="modal"
    ...
    @foreach ($shift as $item)
        <div class="modal fade modal-sm" id="editModal{{ $item->id }}" tabindex="-1"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="grupinpu">
                                ...
                                <input type="text" name="nama_shift" class="inputmodal" id="editDetail"
                                    placeholder="Masukkan nama shift" value="{{ $item->nama_shift }}">
                            </div>
                            <div class="grupinput">
                                <div><label for="jaml" class="labelmodal">Jam</label></div>
                                <input type="text" name="jam_masuk" class="inputmodal" id="editJam"
                                    placeholder="Masukkan jam masuk - keluar" value="{{ $item->jam_masuk }}">
                            </div>
                            <div class="grupinput">
                                <div><label for="Istirahat" class="labelmodal">Istirahat</label></div>
                                <input type="text" name="istirahat" class="inputmodal" id="editIstirahat"
                                    placeholder="Masukkan jam istirahat" value="{{ $item->istirahat }}">
                            </div>
                        </div>
                        <div class="modal-footer">
                            <div class="buttongrup gap-3">
                                ...
                                <button type="submit" class="btn btn-danger" data-bs-dismiss="modal" aria-label="Close"
                                    onclick="showedit()">Simpan</button>
                            </div>
                        </div>
                    </div>
                </form>
            ...
            <form action="{{ route('mitra.addShift') }}" method="post">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="grupinpu">
                            <div><label for="detail" class="labelmodal">Detail</label></div>
                            <input type="text" name="nama_shift" class="inputmodal inputdetail"
                                placeholder="Masukkan nama shift">
                        </div>
                        <div class="grupinput">
                            <div><label for="jaml" class="labelmodal">Jam</label></div>
                            <input type="text" name="jam_masuk" class="inputmodal inputjam"
                                placeholder="Masukkan jam masuk - keluar">
                        </div>
                        <div class="grupinput">
                            <div><label for="Istirahat" class="labelmodal">Istirahat</label></div>
                            <input type="text" name="istirahat" class="inputmodal inputistirahat"
                                placeholder="Masukkan jam istirahat">
                        </div>
                    </div>
                    <div class="modal-footer">
    ...
    <script>
        function sowsukses() {
            ...
            var newRow = "<tr>" +
                ...
                // Nomor dapat disesuaikan dengan jumlah baris yang sudah ada
                "<td>" + detail + "</td>" +
                "<td>" + jam + "</td>" +
                "<td>" + istirahat + "</td>" +
                "<td class = 'ratatengah'>" +
