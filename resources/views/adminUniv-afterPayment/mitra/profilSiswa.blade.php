...
<div class="wadah">
    ...
    <div class="judul d-flex flex-column justify-content-start">
        <a href="/Option-TeamAktif-SeeAllTeams"> <i class="fa-solid text-dark ikon-kiri fa-chevron-left icon fs-1 p-2"></i></a>
...
<script>
    function showsukses(){
        swal("Berhasil", "Profil mahasiswa berhasil diperbarui", "success");
    }
</script>
@endsection