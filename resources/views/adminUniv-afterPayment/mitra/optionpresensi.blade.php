...
@section('content')
    ...
    <script>
        ...
        thead style = "text-align: center;" >
            ...
            @foreach ($userAdmin as $user)
                ...
                tr >
                    ...
                    td class = "bates"
                href > < a href = "/mitra-detailprofil" > {{ $user->nama_lengkap }} < /a></td >
                    <
        ...
        id = "exampleModalLabel" > Edit Presensi < /h1> <
            /div>
        ...
        style = "background-color:pink; " > Lorem ipsum dolor, sit amet consectetur adipisicing elit
            .Dolorum necessitatibus enim rem delectus eaque ? Iure corporis earum commodi aliquam, quos, consequuntur rem,
            reiciendis quia in sit autem odio praesentium mollitia. < /div> <
            /div> <
            div style = "float:left;" >
            <
            div style = "position: relative;" >
        ...
        onclick = "showsukses()" > Save < /button> <
            /div> <
            /div> <
            /div> <
            /div> <
        ...
        aria - hidden = "true" >
            ...
            <
            h1 class = "modal-title fs-5"
        id = "exampleModalLabel" > log activity < /h1> <
            /div> <
        ...
        <
        button type = "button"
        class = "btn btn-primary p-1" > Save < /button> <
            /div> <
            /div> <
            /div> <
            /div> <
...
=======
    ...
    <<<<<<< HEAD=======function checkAll(ele) { var checkboxes=document.getElementsByTagName('input'); if (ele.checked) {
        for (var i=0; i < checkboxes.length; i++) { if (checkboxes[i].type=='checkbox' ) { checkboxes[i].checked=true; } } }
        else { for (var i=0; i < checkboxes.length; i++) { if (checkboxes[i].type=='checkbox' ) {
