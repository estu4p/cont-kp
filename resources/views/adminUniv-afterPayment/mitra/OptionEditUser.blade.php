...
@section('content')
    ...
    <div class="ruangan">
        ...
        <form action="{{ route('detailProfilDivisiSiswa', $users->id) }}" method="POST">
            @csrf
            <div class="row gap-5 p-5">
                <div class="data_diri col-3" style="box-sizing: border-box;">
                    <br>
                    <label>Nama Lengkap</label>
                    <input type="text" value="{{ $users->nama_lengkap }}" class="input" readonly>
                    <label>Nomor Induk Mahasiswa</label>
                    <input type="text" value="{{ $users->nomor_induk }}" class="input" readonly>
                    <label>Program Studi/Jurusan</label>
                    <input type="text" value="{{ $users->jurusan }}" class="input" readonly>
                    <label>Nomor HP</label>
                    <input type="text" value="{{ $users->no_hp }}" class="input" readonly>
                </div>
