                            ...
                            <div class="d-flex flex-wrap">Privilege:
                                @foreach ($user['privilege'] as $privilege)
                                    <span class="privilege-item"
                                        style="font-size: 10px; font-weight: 500;">{{ $privilege }}</span>
                                @endforeach
                            </div>
                        </div>
                        <div class="ms-auto">
                            <button data-bs-toggle="modal" data-bs-target="#userModal" data-role="{{ $user['role'] }}"
                                onclick="populateModal('edit', '{{ $user['role'] }}')"
                                class="btn btn-info me-2">Edit</button>
