...
<div class="container d-flex justify-content-center align-items-center vh-100">
    <div class="box-reset">
        ...
        <form action="">
            <input type="text" name="email" id="email" placeholder="Masukan alamat E-Mail" oninput="validateEmail()">
            <div class="button-container text-center">
                <div class="mt-5">
                    <a href="/user/reset-password/otp" id="kirim-otp" class="reg-button border-0 shadow fw-semibold text-decoration-none" style="background-color: #A61C1CE5; padding: 15px 80px; pointer-events: none; opacity: 0.5;">Kirim OTP</a>
