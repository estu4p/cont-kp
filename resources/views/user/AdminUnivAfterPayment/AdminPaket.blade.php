...
@section('content')
    ...
    <<<<<<<<< Temporary merge branch 1 <div class="tittle-container">
                                ...
                                <div class="container d-flex flex-row p-5" style="box-sizing: border-box;">
                                    <div class="card col-3">
                                        ...
                                        <a href="{{ route('checkout.bronze.adminUniv') }}">
                                            <button type="button"
                                                class="btn btn-outline-danger mb-4 rounded-pill">Upgrade</button>
                                        </a>
                                    ...
                                    <div class="card col-3">
                                        ...
                                        <div class="tittle-container">
                                            <h1 style="padding: 20px;">Pilih Paket Website Presensi<br> Sesuai Kebutuhan
                                                Anda</h1>
                                            <div class="wadah">
                                                <div class="container row justify-content-around  p-md-2 "
                                                    ...
                                                    <div class="card col-md-5 col-lg-3  ">
                                                        <div class="bg-white child w-100">
                                                            ...
                                                            <a href="/CheckoutSilver">
                                                                <button type="button"
                                                                    class="btn btn-outline-primary mb-4 rounded-pill">Upgrade</button>
                                                            </a>
                                                            <<<<<<<<< Temporary merge branch 1 </div>
                                                        </div>
                                                        ...
                                                        <div class="card col-md-5 col-lg-3 ">
                                                            ...
                                                            <div class="card col-3">
                                                                ...
                                                                <div class="features my-3">
                                                                    <table>
                                                                        <tr>
                                                                            <td><i class="fa-regular fa-square-check"></i>
                                                                            </td>
                                                                            <td>Presensi Siswa/Mahasiswa</td>
                                                                        </tr>
                                                                        <tr>
                                                                ...
                                                                <a href="/CheckoutGold">
                                                                    <button type="button"
                                                                        class="btn btn-outline-success mb-4 rounded-pill">Upgrade</button>
                                                                </a>
                                                            ...
                                                            <div class="card col-3">
                                                                ...
                                                                <div class="price" style="color: purple">Rp 10.000.000
                                                                </div>
                                                                <div class="period">/tahun</div>
                                                                <div class="features my-3">
                                                                    <table>
                                                                ...
                                                                <a href="/CheckoutPlatinum">
                                                                    <button type="button"
                                                                        class="btn btn-outline-secondary mb-4 rounded-pill">Upgrade</button>
                                                                </a>
