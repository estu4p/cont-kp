...
<body>
    <div class="tittle-container">
        <div class="fixed-header">
            <h1><b>Pilih Paket Website Presensi<br> Sesuai Kebutuhan Anda</b></h1>
        </div>
        <div class="d-flex justify-content-end p-5" style="margin-left: 5%; width:120%; height:80%;">
            <div class="card col-3 mx-2" style="border-radius: 20px;" >
                <div class="plan-title mt-5">Bronze</div>
                ...
                <a href="{{ route('checkout.bronze.adminUniv') }}">
                    <button type="button" class="btn btn-outline-danger mb-4 rounded-pill">Upgrade <i class="fa-solid fa-circle-chevron-right"></i> </button>
                </a>
            </div>

            <div class="card col-3 mx-2" style="border-radius: 20px;">
                <div class="plan-title mt-5">Silver</div>
                ...
                <a href="/CheckoutSilver">
                    <button type="button" class="btn btn-outline-primary mb-4 rounded-pill">Upgrade <i class="fa-solid fa-circle-chevron-right"></i></button>
                </a>
            </div>

            <div class="card col-3 mx-2" style="border-radius: 20px;">
                <div class="plan-title mt-5">Gold</div>
                ...
                <a href="/CheckoutGold">
                    <button type="button" class="btn btn-outline-success mb-4 rounded-pill">Upgrade <i class="fa-solid fa-circle-chevron-right"></i></button>
                </a>
            </div>

            <div class="card col-3 mx-2" style="border-radius: 20px;">
                <div class="plan-title mt-5">Platinum</div>
                ...
                <a href="/CheckoutPlatinum">
                    <button type="button" class="btn btn-outline-secondary mb-4 rounded-pill">Upgrade <i class="fa-solid fa-circle-chevron-right"></i></button>
                </a>
            </div>
        </div>
</body>
