            ...
            <div class="row">
                <div class="col-md-12">
                   ...
                   <br>
                    ...
                    <div class="menu">
                        <div class="p-1"> <button class="btn btn-secondary dropdown-toggle tes" type="button" data-bs-toggle="dropdown"
                            aria-expanded="false">
                            Pilih Menu Presensi
                        </button>
    ...
    <table class="table" style="font-size: 10px;">
        <thead style="text-align: center;">
            <tr>
                <th rowspan="2" style="vertical-align: middle;">
                    <input type="checkbox" id="select-all-checkbox">&nbsp;No
                </th>
        ...
        <tbody>
            <tr>
                ...
                <td class="bates" href><a href="/dataPresensi">simpay</a></td>
...
{{-- modallllllllllllllllllllllllllll --}}
    ...
    document.addEventListener('DOMContentLoaded', function () {
        // Menambahkan event listener ke checkbox "Select All"
        document.getElementById('select-all-checkbox').addEventListener('change', function(event) {
            // Mendapatkan semua checkbox di dalam tbody
            var checkboxes = document.querySelectorAll('tbody input[type="checkbox"]');
            // Loop melalui setiap checkbox dan atur propertinya berdasarkan checkbox "Select All"
            checkboxes.forEach(function(checkbox) {
                checkbox.checked = event.target.checked;
            });
        });

        // Fungsi untuk menangani klik pada tombol check atau cross
        function handleButtonClick(buttonNumber) {
            var buttonId = 'button' + buttonNumber;
            var button = document.getElementById(buttonId);
            if (!button.classList.contains('btn-with-checkmark')) {
