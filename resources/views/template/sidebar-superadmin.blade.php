...
<div class="sidebar">
  ...
  <ul class="nav flex-column">
      <li class="nav-item">
          <a class="nav-link" href="/super-admin">Dashboard</a>
      </li>
      <li class="nav-item">
          <a class="nav-link" href="/super-admin/data-admin">Data Admin</a>
      </li>
      <li class="nav-item">
          <a class="nav-link" href="/super-admin/langganan">Langganan</a>
      </li>
