...
<body>
        ...
        <div class="row justify-content-center align-items-center" style="height: 100vh;">
            <div class="col-md-8 row justify-content-center">
                ...
                <div class="card   col-7 p-0">
                    ...
                    <p class=" text-center">Log In</p></div>
  ...
  <form>
    ...
    <div class="d-flex gap-0 justify-content-between row flex-row">
      ...
      <label class="form-check-label fz7 " for="remember">Remember me</label>
    </div>
    <div class="kanan d-flex align-items-start justify-content-end gap-2 flex-row col-7 ">
       <p class="fz7 ">   Forgot password? <a href="#" class="btn btn-link fz9 ">Contact admin</a> </p>
    </div>
